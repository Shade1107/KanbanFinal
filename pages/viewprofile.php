...
<div class="container bootstrap snippets bootdey">
  ...
  <div class="col-md-6 text-end">
    <a href="profileEdit.php" id="edit" class="btn btn-custom"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#c28c9f" class="bi bi-pencil-square" viewBox="0 0 16 16">
